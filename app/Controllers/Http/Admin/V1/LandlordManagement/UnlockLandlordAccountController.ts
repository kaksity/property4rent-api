...
import { ERROR, LANDLORD_ACCOUNT_NOT_FOUND, LANDLORD_ACCOUNT_UPDATE_SUCCESSFUL, SOMETHING_WENT_WRONG } from 'App/Helpers/Messages/SystemMessage'
...
export default class UnlockLandlordAccountController {
    ...
    public async handle({request, response}: HttpContextContract) {
        try {
            ...
            console.log('UnlockLandlordAccountController.handle => ', UnlockLandlordAccountControllerError)
