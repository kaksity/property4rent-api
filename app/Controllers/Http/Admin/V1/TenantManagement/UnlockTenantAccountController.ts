...
export default class UnlockTenantAccountController {
  ...
  public async handle({ request, response }: HttpContextContract) {
    ...
    } catch (UnlockTenantAccountControllerError) {
      console.log('UnlockTenantAccountController.handle => ', UnlockTenantAccountControllerError)
