...
export default class VerifyTenantAccountController {
  ...
  public async handle({ request, response }: HttpContextContract) {
    ...
    } catch (VerifyTenantAccountControllerError) {
      console.log('VerifyTenantAccountController.handle => ', VerifyTenantAccountControllerError)
