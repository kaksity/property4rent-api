...
import {
  NULL_OBJECT,
  SEND_LANDLORD_ACCOUNT_UNLOCKED_EMAIL_SUBJECT,
  SEND_LANDLORD_ACCOUNT_UNLOCKED_EMAIL_TEMPLATE,
...
export default class SendLandlordAccountUnlockedNotificationJob implements JobContract {
  public key = SEND_LANDLORD_ACCOUNT_UNLOCKED_NOTIFICATION_JOB
  ...
  public async handle(job) {
    ...
    await MailClient.send({
      ...
      subject: SEND_LANDLORD_ACCOUNT_UNLOCKED_EMAIL_SUBJECT,
      template: SEND_LANDLORD_ACCOUNT_UNLOCKED_EMAIL_TEMPLATE,
    })
  }
}
