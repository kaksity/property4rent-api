...
import {
  NULL_OBJECT,
  SEND_LANDLORD_ACCOUNT_ACTIVATION_EMAIL_SUBJECT,
  SEND_LANDLORD_ACCOUNT_ACTIVATION_EMAIL_TEMPLATE,
...
export default class SendLandlordAccountActivationNotificationJob implements JobContract {
  ...
  public async handle(job) {
    ...
    await MailClient.send({
      ...
      subject: SEND_LANDLORD_ACCOUNT_ACTIVATION_EMAIL_SUBJECT,
      template: SEND_LANDLORD_ACCOUNT_ACTIVATION_EMAIL_TEMPLATE,
    })
  }
}
