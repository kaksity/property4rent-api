...
import {
  NULL_OBJECT,
  SEND_TENANT_ACCOUNT_PASSWORD_RESET_EMAIL_SUBJECT,
  SEND_TENANT_ACCOUNT_PASSWORD_RESET_EMAIL_TEMPLATE,
...
export default class SendTenantAccountPasswordResetNotificationJob implements JobContract {
  public key = SEND_TENANT_ACCOUNT_PASSWORD_RESET_NOTIFICATION_JOB
  ...
  public async handle(job) {
    ...
    await MailClient.send({
      ...
      subject: SEND_TENANT_ACCOUNT_PASSWORD_RESET_EMAIL_SUBJECT,
      template: SEND_TENANT_ACCOUNT_PASSWORD_RESET_EMAIL_TEMPLATE,
    })
  }
}
