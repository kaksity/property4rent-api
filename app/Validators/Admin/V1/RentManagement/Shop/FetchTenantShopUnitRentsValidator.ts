...
export default class FetchTenantShopUnitRentsValidator {
  ...
  public schema = schema.create({
    ...
    shop_unit_identifier: schema.string.optional(),
  ...
  public messages: CustomMessages = {
    ...
    'shop_unit_identifier.string': 'Shop unit must be a valid string',
