...
Route.group(function () {
  ...
  Route.post('account-activation/request-otp-token', 'RequestAccountActivationOtpTokenController')
    .as('landlord.v1.onboarding.request-account-activation-otp-token')
    .middleware('auth:landlordTeamMember')
  Route.post('account-activation/verify-otp-token', 'VerifyAccountVerificationOtpTokenController')
